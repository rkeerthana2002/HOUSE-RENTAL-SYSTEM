...
body{
 background-image: url('https://tse3.mm.bing.net/th?id=OIP.V09MTA6vF8ezkqInyG8JqwHaEY&pid=Api&P=0&w=296&h=176');
...
<form class="modal-content animate" action="conreg.php" method="post">
<div class="wrapper">
  <div class="title">
  ...
  <div class="form">
   ...
   <div class="input_field">
      <input type="house no" placeholder="password"  name="password" required class="input">
    ...
    <div class="input_field">
      <input type="text" placeholder="phone number"name="phoneno" required class="input">
      <i class="fa fa-phone"></i>
    </div>
    <div class="input_field">
      <input type="house no" placeholder="address"  name="address" required class="input">
      <i class="fa fa-home"></i>
    </div>
  <b> <center><button type="submit">Register</button><center><b>
